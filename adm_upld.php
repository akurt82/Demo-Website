...
<center>
	...
	// Modul wird geladen //
	echo '<iframe onmouseover = "javascript:SetDisp(\'wechsler\',false);" src = "uploadmplf.php?'.session_id().'&allimages=1&lang='.$lang.'&fdir=bilder&sdir=bilder2" style = "width:996px; height: 600px; border: none;" id = "uplif" name = "uplif" frameborder="0" scrolling="no" onload = "javascript:iframeSz(this);"></iframe>';
?>
	</div>
